...
USER_SESSION_ID = str(os.environ.get('COOKIE'))       # Get your session by inspecting the session cookie content in your web browser while connected to adventofcode and paste it here as plain text in between the ". Leave at is to not download inputs.
...
author = "TonyxSun"               # Name automatically put in the code templates.
...
date = "December " + datetime.today().strftime('%d') + ", 2022"              # Date automatically put in the code templates.
